<div class="col-10 mt-2">
    <div class="kotakkanan ">
        <h2 style="font-family:'poppins'">Detail Laporan</h2>
        <div class="row ">
            <div class="col-7 mt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-8 mt-2">
                        <textarea type="text" class="form-control" rows="4" readonly><?php echo $data['isi_laporan']?></textarea>
                    </div>
                </div>
            </div>
        ...
        ?>
        <form action="proses/proses_tanggapan.php" method="POST">
        ...
        <textarea type="text" class="form-control mt-2" rows="5" name="tanggapan" placeholder="Tulisa tanggapan anda disini" required></textarea>
        <a href="aduan.php" class="btn btn-primary mt-4">Kembali</a>
        <button type="submit" onclick="return confirm('Yakin akan dikirim?')"  class="btn btn-danger mt-4">Kirim</button>
        </form>
