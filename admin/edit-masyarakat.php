      ...
      <div class="row mt-3">
        <div class="col-6">
          ...
          <div class="container-profile">
            ...
            <?php 
              require "../koneksi.php";
              $proses=mysqli_query($host,"SELECT*FROM masyarakat WHERE nik='$_GET[id_mas]'");
              $data=mysqli_fetch_array($proses);
              ?>
              <label for="nik" class="mt-4" >NIK :</label>
              <input type="text" name="id_petugas" class="boxtext" id="username" style="background-color:transparent;" value="<?php echo $data['nik']?>" readonly required>
              <label for="nik" class="mt-3">Username :</label>
              ...
              <input type="text" name="nama" class="boxtext" id="nama" style="background-color:transparent;" value="<?php echo $data['nama']?>" disabled required>
              ...
              <a href="masyarakat.php" class="btn btn-primary mt-3">Kembali</a>
            </form>
          </div>
        </div>
        <div class="col-6">
          ...
          <div class="container-profile">
            <form action="proses/adminmagic/edit_passwordmas.php" method="post" enctype="multipart/form-data" >
              <label for="nik" class="mt-2" >NIK :</label>
              <input type="text" name="nik" class="boxtext form-control" id="username" style="background-color:transparent;" value="<?php echo $data['nik']?>" readonly required>
